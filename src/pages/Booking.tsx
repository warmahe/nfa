             ...
             {step === 3 && (
                ...
                >
                   ...
                   <div className="border border-gray-300 p-6 space-y-6 bg-teal-50 rounded-lg shadow-soft">
                      <div className="flex items-center gap-4 mb-4 text-teal-700"><CreditCard /> <span className="font-medium tracking-tight font-medium text-sm">SECURE PAYMENT (Test Mode)</span></div>
      ...
      <div className="relative">
         <div className="sticky top-32 border border-gray-300 p-6 bg-white shadow-soft-lg rounded-lg">
            ...
            <div className="mb-6 flex gap-4">
               ...
               <div>
                  <h4 className="font-bold text-sm leading-tight mb-2 text-gray-900">{pkg.title}</h4>
