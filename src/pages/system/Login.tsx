    ...
    <div className="min-h-screen bg-[#FCFBF7] flex items-center justify-center p-6 nfa-texture">
      <div className="w-full max-w-md bg-white border-[4px] border-[#121212] p-8 md:p-12 shadow-[12px_12px_0_0_#121212]">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            <label className="block font-black text-[10px] uppercase tracking-widest mb-2">Email</label>
            <input 
              type="email" 
              required
              value={email}
          ...
          <div>
            <label className="block font-black text-[10px] uppercase tracking-widest mb-2">Password</label>
            <input 
              type="password" 
              required
              value={password}
