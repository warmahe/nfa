    ...
    <div className="pt-20 bg-white text-gray-900 min-h-screen relative pb-32">
      ...
      <div className="w-full relative border-b border-teal-700">
        ...
        {images.length > 1 && (
          <div className="bg-white border-b border-gray-200 px-4 md:px-12 py-4 flex gap-3 overflow-x-auto">
            {images.map((img, idx) => (
              <button
                ...
                className={`shrink-0 w-20 h-20 rounded-lg overflow-hidden border-2 transition-all hover:border-teal-500 ${
         ...
         <div className="absolute inset-0 bg-linear-to-t from-white via-white/30 to-transparent flex flex-col justify-end p-6 md:p-12 max-w-7xl mx-auto w-full pointer-events-none">
