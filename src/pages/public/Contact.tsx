      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="mb-20 border-b-4 border-[#121212] pb-12">
          <h1 className="font-brand font-black text-[clamp(3rem,8vw,8rem)] uppercase tracking-tighter text-[#121212] leading-[0.85]">
             Get in <br/><span className="text-[#9E1B1D]">Touch.</span>
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <form className="border-[4px] border-[#121212] bg-white p-8 md:p-12 shadow-[12px_12px_0px_0px_#121212]">
             <h3 className="font-brand font-black text-2xl uppercase mb-8">Send us a Message</h3>
             <div className="space-y-6">
                <input type="text" placeholder="Your Full Name" className="w-full border-2 border-[#121212] p-4 font-black uppercase text-xs tracking-widest outline-none focus:bg-[#F4BF4B]/10" />
                <input type="email" placeholder="Your Email Address" className="w-full border-2 border-[#121212] p-4 font-black uppercase text-xs tracking-widest outline-none focus:bg-[#F4BF4B]/10" />
                <textarea rows={5} placeholder="Your Message" className="w-full border-2 border-[#121212] p-4 font-black uppercase text-xs tracking-widest outline-none focus:bg-[#F4BF4B]/10" />
