  ...
  return (
    <section className="bg-nfa-gold border-b-4 border-nfa-charcoal grid grid-cols-1 lg:grid-cols-2">
      ...
      <div className="p-8 lg:p-16 bg-nfa-cream flex flex-col justify-center">
         <p className="font-brand text-2xl md:text-4xl font-black italic text-nfa-charcoal leading-tight mb-8 border-l-8 border-burugundy pl-6">
           "{REVIEWS[0].content}"
         </p>
         <div className="flex items-center gap-6 mt-8 border-t-4 border-nfa-charcoal pt-8">
            ...
            <div>
               ...
               <p className="font-sans text-xs font-bold uppercase tracking-widest text-burugundy">{REVIEWS[0].role}</p>
            </div>
         </div>
      </div>
    </section>
