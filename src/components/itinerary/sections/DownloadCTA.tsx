            ...
            {pkg?.itineraryPDF && (
              <div className="mt-8 pt-8 border-t-2 border-[#121212]/20">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-[#121212] text-[#F4BF4B] px-8 py-4 font-black text-[10px] uppercase tracking-widest border-2 border-[#121212] hover:bg-[#9E1B1D] hover:border-[#9E1B1D] transition-colors shadow-[4px_4px_0px_0px_#121212] active:translate-x-1 active:translate-y-1 active:shadow-none"
                >
