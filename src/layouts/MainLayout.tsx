  ...
  return (
    ...
    <div className="relative min-h-[100dvh] flex flex-col bg-[#FCFBF7] font-sans nfa-texture selection:bg-nfa-gold selection:text-nfa-charcoal isolate w-full">
      ...
      <footer className="w-full border-t-[6px] border-[#121212] bg-[#FCFBF7] text-[#121212] block">
        ...
        <div className="w-full max-w-[1440px] mx-auto px-[clamp(1rem,4vw,3rem)] py-12 md:py-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link to="/testimonials" className="font-sans text-xs uppercase font-bold tracking-[0.2em] text-[#121212] hover:text-[#9E1B1D] transition-colors">Testimonials</Link>
          </div>
